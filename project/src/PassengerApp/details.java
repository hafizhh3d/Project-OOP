...
public class details extends javax.swing.JFrame {
    ...
    public details(String name, String seat, int index)
    {
        initComponents();
        ...
        {
            case "F":
                jTextField1.setText(PassengerApp.firstPassengerList.get(index).getFirstName());
                jTextField2.setText(PassengerApp.firstPassengerList.get(index).getLastName());
                
                jTextField3.setText(PassengerApp.firstPassengerList.get(index).getCity());
                jTextField4.setText(PassengerApp.firstPassengerList.get(index).getCountry());
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Baggage Weight (kg)");
