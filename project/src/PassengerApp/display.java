...
public class display extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("To see the Passenger Details, Please enter the information below");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        {
            j = new JFrame();
            JOptionPane.showMessageDialog(j,"Data Not Found!","Alert",JOptionPane.WARNING_MESSAGE);
        }
            else
        {
            new details(fname, seat, index).setVisible(true);
            this.setVisible(false);
        }
